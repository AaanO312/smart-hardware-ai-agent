...
def get_weather(city: str) -> str:
    return f"城市{city}天气为晴，气温26摄氏度，空气湿度50%，南风1级，AQI21，最近6小时将于概率极低"
...
@tool(description="在外部系统中获取指定用户在指定月份的使用记录，以纯字符串形式返回，如果未检索到返回空字符串")
...
@tool(description="无入参，无返回值，调用后触发中间件自动为报告生成的动态场景注入上下文信息，为后续提示词切换提供上下文信息")
